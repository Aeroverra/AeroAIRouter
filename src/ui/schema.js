...
export const SECTIONS = [
  ...
  },
  {
    ...
    fields: [
      ...
      { path: "discord.guilds.home.channels.bot", label: "Owner-alert channel ID", type: "string", advanced: true, help: "Legacy: where the watchdog posts owner alerts." },
      { path: "discord.guilds.public.id", label: "Voice/greetings server ID", type: "string", advanced: true, help: "Legacy: guild used for voice + presence greetings + the weekly health report." },
      { path: "discord.guilds.public.channels.bot", label: "Health-report channel ID", type: "string", advanced: true, help: "Legacy: weekly health check posts here." },
      { path: "discord.guilds.public.channels.general", label: "Greetings/voice channel ID", type: "string", advanced: true, help: "Legacy: presence greetings + voice join target." },
